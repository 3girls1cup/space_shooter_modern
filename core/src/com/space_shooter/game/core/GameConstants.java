...
public abstract class GameConstants {
    ...
    static public int COLLISION_DAMAGE = 10;
    static public int ENNEMY_BASE_HEALTH = 10;
    // Paramétres de la classe PlayerShip
    static public float PLAYER_SHIP_RADIUS = 2f;
    static public int PLAYER_SHIP_HEALTH = 100;
    ...
    static public int PLAYER_DAMAGE = 50;
    ...
    static public int KAMIKAZE_SHIP_HEALTH_FACTOR = 1;
    ...
    static public int DISTANCE_SHOOTER_HEALTH_FACTOR = 2;
    ...
    static public int DISTANCE_SHOOTER_DAMAGE = 10;
    ...
    static public int LASER_DAMAGE = 5;
    static public String BASIC_NAME = "Basic";
    static public String PLAYER_BASIC_PROJECTILE_FIXTURE_NAME = "basic_projectile_player";
    static public String ENNEMY_BASIC_PROJECTILE_FIXTURE_NAME = "basic_projectile_ennemy";
    static public int BASIC_DAMAGE = 10;
    static public String[] WEAPON_NAMES = { BASIC_NAME, LASER_NAME };
}
