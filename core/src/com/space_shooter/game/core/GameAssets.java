...
public class GameAssets {
    ...
    public static final String BASIC_WEAPON_ENEMY = "weapons/BasicEnemy.png";
    ...
    public static final String SOUNDTRACK = "sounds/soundtrack.mp3";
    ...
    private GameAssets() {
        ...
        assets.put(BASIC_WEAPON_ENEMY, Texture.class);
    ...
    public Skin getSkinInstance(String asset) {
        if (assets.get(asset) == Skin.class) {
            return assetManager.get(asset, Skin.class);
        }
        return null;
    }
